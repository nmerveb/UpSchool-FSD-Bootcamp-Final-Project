...
namespace Scraper.WebApi.Controllers
{
    ...
    public class AuthenticationController : ApiControllerBase
    {
        ...
        private const string REDIRECT_URI = "https://localhost:7287/api/Authentication/GoogleSignIn";
        ...
        public async Task<IActionResult> GoogleSignInAsync(string code, CancellationToken cancellationToken)
        {
            ...
            var socialLoginRequest = new SocialLoginRequest(payload.Email, payload.GivenName, payload.FamilyName);

            var jwtDto = await _authenticationService.SocialLoginAsync(socialLoginRequest, cancellationToken);
